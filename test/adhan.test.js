...
test("calculating times for turkey method", () => {
    ...
    const p = new adhan.PrayerTimes(new adhan.Coordinates(41.005616, 28.976380), date, params);
...
test("calculating times for the egyptian method", () => {
    ...
    const p = new adhan.PrayerTimes(new adhan.Coordinates(30.028703, 31.249528), date, params);
...
test("getting recommended high latitude rule", () => {
    ...
    expect(adhan.HighLatitudeRule.recommended(coords1)).toBe(adhan.HighLatitudeRule.MiddleOfTheNight);
