...
| highLatitudeFajrRule  | Value from the HighLatitudeFajrRule object, provides support for AqrabYaum or independent Middle Of the Night during perpetual twilight in high latitude regions. `Default` is the default value which falls back to the value set for `HighLatitudeRule`                                                                                                                    |
...
| adhan.CalculationMethod.UnitedKingdom()         | Also known as the Wifaqul Ulama method. Used in the United Kingdom. Fajr is 18° and MiddleOfTheNight during perpetual twilight. Aqrabul Youm may also be used. Isha 15° and Seventh of the night during perpetual twilight conditions. Adds 4 minutes to Dhuhr and 5 minutes to Maghrib to factor refraction.                                      |
